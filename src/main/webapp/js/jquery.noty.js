...
(function ($) {
    $.noty = function (options, customContainer) {
        ...
        base.render = function (isGrowl) {
            ...
            // Close on self click
            if (base.options.closeOnSelfClick) $noty.bind('click', function () {
                $noty.trigger('noty.close');
            }).css('cursor', 'pointer');
            // Close on self mouseover
            if (base.options.closeOnSelfOver) $noty.bind('mouseover', function () {
                $noty.trigger('noty.close');
            }).css('cursor', 'pointer');
        ...
        base.show = function (isGrowl) {
            ...
            $noty.one('noty.close', function (event) {
                ...
                // Modal Cleaning
                if (options.modal) $('.noty_modal').fadeOut('fast', function () {
                    $(this).remove();
                });
